            ...
            <div class="card-body">
                <div class="post">
                    <div class="user-block">
                        <img class="img-circle" src="{{ asset('assets/img/agenda.jpg')  }}"
                            alt="{{ $agenda->title }}" />
                        <span class="username">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('files.present', $present->attachment) }}">
                                            <i class="fas fa-paperclip"></i> Lihat Lampiran
                                        </a>
                                        @else
                                        -
                                ...
                                @empty
                                <tr>
                                    <td colspan="6">Belum diselesaikan.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <textarea name="description" type="text" id="description" class="form-control"
                            placeholder="Catatan" rows="4" autocomplete="off" required></textarea>
