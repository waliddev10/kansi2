                ...
                <ul class="products-list product-list-in-card p-2">
                    <li class="item mx-3">
                        ...
                        <div class="product-info">
                            <a class="text-dark product-title">Akuntansi</a>
                            <span class="product-description">
                                Topik mengenai Akuntansi
                            </span>
                            <a href="#"><span class="badge badge-primary"><i class="far fa-eye"></i> Detail</span></a>
                        </div>
                    </li>
                    <li class="item mx-3">
                        <div class="product-img">
                        ...
                        <div class="product-info">
                            <a class="text-dark product-title">Verifikasi</a>
                            <span class="product-description">
                                Topik mengenai Verifikasi
                            </span>
                            <a href="#"><span class="badge badge-primary"><i class="far fa-eye"></i> Detail</span></a>
                        </div>
                    </li>
            ...
            <form class="form-inline" method="get">
                <div class="input-group"> <input name="q" class="form-control" type="search"
                    ...
                    <div class="input-group-append"
                        style="background-color: #ffffff;background-clip: padding-box;border-top: 1px solid #ced4da;border-bottom: 1px solid #ced4da;border-right: 1px solid #ced4da; border-left: none;height: calc(2.25rem + 2px);">
                ...
                <div class="direct-chat-msg">
                    <div class="direct-chat-infos clearfix">
                        ...
                        <span class="direct-chat-timestamp float-right">{{
                            \Carbon\Carbon::parse($question->created_at)->isoFormat('D MMMM YYYY') }}</span>
                    </div>
                ...
                <div class="direct-chat-msg right">
                    <div class="direct-chat-infos clearfix">
                        ...
                        <span class="direct-chat-timestamp float-left">{{
                            \Carbon\Carbon::parse($answer->created_at)->isoFormat('D MMMM YYYY') }}</span>
                    </div>
                    <img class="direct-chat-img" src="{{ asset('assets/img/user.jpg') }}" alt="message user image">
                    <div class="direct-chat-text">
                        {{ $answer->content }}
