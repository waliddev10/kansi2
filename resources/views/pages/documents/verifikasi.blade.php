        ...
        <ul class="products-list product-list-in-card p-2">
            ...
            <li class="item mx-3">
                ...
                <div class="product-info">
                    <a class="text-dark product-title d-block">{{ $doc->title }}</a>
                    <a class="text-dark product-title d-block">{{ $doc->attachment }}</a>
                    <a href="{{ route('files.document', $doc->attachment) }}">
                        <span class="badge badge-primary"><i class="far fa-download"></i> Download</span>
                    </a>
                </div>
            </li>
            @endforeach
